...
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>یوزر</b> <code>»</code> '..group[tostring(target)]['settings']['lock_username']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>ادیت</b> <code>»</code> '..group[tostring(target)]['settings']['lock_edit']..''
...
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>استکیر</b> <code>»</code>'..group[tostring(target)]['settings']['lock_sticker']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>فش</b> <code>»</code>'..group[tostring(target)]['settings']['lock_fosh']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>مخاطب</b> <code>»</code>'..group[tostring(target)]['settings']['lock_contact']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>بات</b> <code>»</code>'..group[tostring(target)]['settings']['lock_bot']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>اینگیلیسی</b> <code>»</code> '..group[tostring(target)]['settings']['lock_english']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>فارسی</b> <code>»</code> '..group[tostring(target)]['settings']['lock_persian']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>تی جی</b> <code>»</code> '..group[tostring(target)]['settings']['lock_tgservice']..''
...
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>اشتراک</b> <code>»</code> '..group[tostring(target)]['settings']['lock_community']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>All</b> <code>»</code> '..group[tostring(target)]['settings']['mute_all']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>تکست</b> <code>»</code> '..group[tostring(target)]['settings']['mute_text']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>عکس</b> <code>»</code> '..group[tostring(target)]['settings']['mute_photo']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>ویدیو</b> <code>»</code> '..group[tostring(target)]['settings']['mute_video']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>ویس</b> <code>»</code> '..group[tostring(target)]['settings']['mute_voice']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>فایل</b> <code>»</code> '..group[tostring(target)]['settings']['mute_document']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>موزیک</b> <code>»</code> '..group[tostring(target)]['settings']['mute_audio']..''
pm = pm..'\n🔐 <code>➣</code> <b>قفل</b> <code>➣</code> <b>گیف</b> <code>»</code> '..group[tostring(target)]['settings']['mute_gif']..''
--pm = '<code>→→→→→→→→→→→→</code>'
pm = pm..'\n'
