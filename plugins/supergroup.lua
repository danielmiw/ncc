...
--pm = pm..'\n <code>💈💈💈💈💈💈💈💈💈</code>'
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>لینک</i> <code>»</code> '..group[tostring(target)]['settings']['lock_link']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>یوزر</i> <code>»</code> '..group[tostring(target)]['settings']['lock_username']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>ادیت</i> <code>»</code> '..group[tostring(target)]['settings']['lock_edit']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>فروارد</i> <code>»</code> '..group[tostring(target)]['settings']['lock_fwd']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>اسپم</i> <code>»</code> '..group[tostring(target)]['settings']['lock_spam']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>استکیر</i> <code>»</code>'..group[tostring(target)]['settings']['lock_sticker']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>فش</i> <code>»</code>'..group[tostring(target)]['settings']['lock_fosh']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>مخاطب</i> <code>»</code>'..group[tostring(target)]['settings']['lock_contact']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>بات</i> <code>»</code>'..group[tostring(target)]['settings']['lock_bot']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>اینگیلیسی</i> <code>»</code> '..group[tostring(target)]['settings']['lock_english']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>فارسی</i> <code>»</code> '..group[tostring(target)]['settings']['lock_persian']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>تی جی</i> <code>»</code> '..group[tostring(target)]['settings']['lock_tgservice']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>تگ</b> <code>»</code> '..group[tostring(target)]['settings']['lock_tag']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>اینلاین</i> <code>»</code> '..group[tostring(target)]['settings']['lock_inline']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>اشتراک</i> <code>»</code> '..group[tostring(target)]['settings']['lock_community']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>All</i> <code>»</code> '..group[tostring(target)]['settings']['mute_all']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>تکست</i> <code>»</code> '..group[tostring(target)]['settings']['mute_text']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>عکس</i> <code>»</code> '..group[tostring(target)]['settings']['mute_photo']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>ویدیو</i> <code>»</code> '..group[tostring(target)]['settings']['mute_video']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>ویس</i> <code>»</code> '..group[tostring(target)]['settings']['mute_voice']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>فایل</i> <code>»</code> '..group[tostring(target)]['settings']['mute_document']..''
pm = pm..'\n🔐 <i>➣</i> <i>قفل</i> <code>➣</code> <i>موزیک</i> <code>»</code> '..group[tostring(target)]['settings']['mute_audio']..''
pm = pm..'\n🔐 <i>➣</code> <i>قفل</i> <i>➣</i> <i>گیف</i> <code>»</code> '..group[tostring(target)]['settings']['mute_gif']..''
--pm = '<code>→→→→→→→→→→→→</code>'
pm = pm..'\n'
